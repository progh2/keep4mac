...
- changes_made: v0.1.44 기준 — #61 Windows 지원(pystray, tray_win.py, autostart winreg, panel.py objc lazy import, keep4mac_win.spec, build_exe.ps1, release.yml Windows job)
