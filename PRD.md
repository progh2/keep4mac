...
> **문서 버전**: v0.1.40 기준 현행화 (2026-05-10)
...
### 3. 사이드바
- 새 노트 / 동기화 / 설정(⚙) 메뉴
- 설정 메뉴: 웹 Keep / 자동시작 토글 / 내 메일 주소 / 언어 변경 / 정보 / 로그아웃 / 종료
...
### 8. 설정 저장
- `~/.config/keep4mac/settings.json`에 내 메일 주소·선택 언어 저장
- 앱 재시작 후에도 유지
...
| [#38](../../issues/38) | 플로팅 독립 윈도우 모드 | enhancement |
